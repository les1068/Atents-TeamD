...
public class Coin2Spawner : Spawner
{
    ...
    protected override IEnumerator Spawn()
    {
        ...
        while (true)
        {
            ...
            GameObject obj = Factory.Inst.GetObject(PoolObjectType.CoinSilver);   // 오브젝트 스포너위치에서 생성              
            Coin2Silver coin = obj.GetComponent<Coin2Silver>();
