...
{ 
    ...
    protected override IEnumerator Spawn()
    {
        ...
        while (true)
        {
            ...
            GameObject obj = Factory.Inst.GetObject(PoolObjectType.CoinCopper);   // 오브젝트 스포너위치에서 생성                                           //Debug.Log(obj.transform.position);
            Coin1Copper coin = obj.GetComponent<Coin1Copper>();
